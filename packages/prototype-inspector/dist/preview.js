...
function MarkdownDocument({ value }) {
  ...
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector__document" }, blocks.map((block, index) => {
    const key = `${block.type}-${index}`;
    if (block.type === "heading") {
      const HeadingTag = block.level === 1 ? "h2" : block.level === 2 ? "h3" : "h4";
      return /* @__PURE__ */ createElement(HeadingTag, { key }, block.text);
    }
    if (block.type === "list") {
      return /* @__PURE__ */ createElement("ul", { key }, block.items.map((item, itemIndex) => /* @__PURE__ */ createElement("li", { key: `${key}-${itemIndex}` }, item)));
    }
    if (block.type === "code") {
      return /* @__PURE__ */ createElement("pre", { key, className: "prototype-inspector__code" }, block.language ? `${block.language}
` : "", block.text);
    }
    return /* @__PURE__ */ createElement("p", { key }, block.text);
  }));
}
function RouteTable({
  routes
}) {
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector__table-wrap" }, /* @__PURE__ */ createElement("table", { className: "prototype-inspector__table" }, /* @__PURE__ */ createElement("thead", null, /* @__PURE__ */ createElement("tr", null, /* @__PURE__ */ createElement("th", null, "Route"), /* @__PURE__ */ createElement("th", null, "Title"), /* @__PURE__ */ createElement("th", null, "Navigation"), /* @__PURE__ */ createElement("th", null, "Component"))), /* @__PURE__ */ createElement("tbody", null, routes.map((route) => /* @__PURE__ */ createElement("tr", { key: route.id }, /* @__PURE__ */ createElement("td", null, route.id), /* @__PURE__ */ createElement("td", null, route.title ?? route.id), /* @__PURE__ */ createElement("td", null, route.navigationId ?? "-"), /* @__PURE__ */ createElement("td", null, route.component ?? "-"))))));
}
function PrototypeDocuments({
  ...
  if (!activeDoc) {
    return /* @__PURE__ */ createElement(EmptyState, { message: "No prototype documents found." });
  }
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector prototype-inspector--canvas" }, /* @__PURE__ */ createElement("header", { className: "prototype-inspector__canvas-header" }, /* @__PURE__ */ createElement("p", { className: "prototype-inspector__eyebrow" }, prototype.id), /* @__PURE__ */ createElement("h2", null, prototype.title)), /* @__PURE__ */ createElement("div", { className: "prototype-inspector__tabs", role: "tablist" }, tabs.map((tab) => /* @__PURE__ */ createElement(
    "button",
    {
    ...
    tab.label
  ))), /* @__PURE__ */ createElement("div", { className: "prototype-inspector__body" }, /* @__PURE__ */ createElement(MarkdownDocument, { value: activeDoc })));
}
...
function PrototypeFlowView({ flow }) {
  const nodes = useMemo(
    () => flow.routes.map((route, index) => ({
      data: {
        label: /* @__PURE__ */ createElement("div", { className: "prototype-inspector__flow-node" }, /* @__PURE__ */ createElement("strong", null, route.title ?? route.id), /* @__PURE__ */ createElement("span", null, route.id), route.navigationId ? /* @__PURE__ */ createElement("small", null, route.navigationId) : null)
      },
      id: route.id,
  ...
  return /* @__PURE__ */ createElement(
    ...
    /* @__PURE__ */ createElement(
      ...
      /* @__PURE__ */ createElement(Background, null),
      /* @__PURE__ */ createElement(Controls, { showInteractive: false })
    )
  );
}
function PrototypeFlowCanvas({
  ...
  if (!prototype.flow) {
    return /* @__PURE__ */ createElement(EmptyState, { message: "No UI flow found for this prototype." });
  }
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector prototype-inspector--canvas prototype-inspector--flow-mode" }, /* @__PURE__ */ createElement(PrototypeFlowView, { flow: prototype.flow }));
}
function PrototypeDataCanvas({
  prototype
}) {
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector prototype-inspector--canvas" }, /* @__PURE__ */ createElement("header", { className: "prototype-inspector__canvas-header" }, /* @__PURE__ */ createElement("p", { className: "prototype-inspector__eyebrow" }, prototype.id), /* @__PURE__ */ createElement("h2", null, "Prototype Data")), /* @__PURE__ */ createElement("div", { className: "prototype-inspector__body" }, prototype.flow ? /* @__PURE__ */ createElement(RouteTable, { routes: prototype.flow.routes }) : null, /* @__PURE__ */ createElement("pre", { className: "prototype-inspector__code" }, JSON.stringify(prototype.data ?? prototype, null, 2))));
}
function EmptyState({ message }) {
  return /* @__PURE__ */ createElement("div", { className: "prototype-inspector prototype-inspector--canvas prototype-inspector--empty" }, /* @__PURE__ */ createElement("p", { className: "prototype-inspector__empty" }, message));
}
...
function createPrototypeInspectorDecorator(options) {
  ...
  return (Story, context) => {
    ...
    if (mode === "docs") {
      return /* @__PURE__ */ createElement(PrototypeDocuments, { prototype });
    }
    if (mode === "flow") {
      return /* @__PURE__ */ createElement(PrototypeFlowCanvas, { prototype });
    }
    return /* @__PURE__ */ createElement(PrototypeDataCanvas, { prototype });
  };
}
